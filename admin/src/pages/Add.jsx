  ...
  return (
    <form onSubmit={onSubmitHandler} className="add-form">
      ...
      <div>
        ...
        <input onChange={(e)=>setTitle(e.target.value)} value={title} placeholder="Type here" type="text" className="add-input" required />
      </div>
      <p>* Include all the details about the item in detail</p>
      <div>
        <p className="add-label">Item Description</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className="add-textarea" placeholder="Type here"></textarea>
      </div>

      <div>
          <p className="add-label">Address</p>
          <textarea onChange={(e)=>setLocation(e.target.value)} value={location}  type="text" placeholder="Type address here" className="add-input" required />
        </div>

      <div className="add-row">
        <div>
          <p className="add-label">Category</p>
          <select onChange={(e)=>setCategory(e.target.value)} value={category} className="add-select">
        ...
        <div>
          ...
          <input onChange={(e)=>setContact(e.target.value)} value={contact} placeholder="Mobile number" type="number" className="add-input" required />
        </div>

        <div>
          <p className="add-label">Price/per day</p>
          <input onChange={(e)=>setPrice(e.target.value)} value={price} type="number" placeholder="Rs" className="add-input" required />
        </div>
      </div>
